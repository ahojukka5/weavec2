...
src/**/*.weave
    │
    ▼ weavefront-cat.sh  (concatenates .weave files)
    ▼ weavefront         (surface Weave → WIR)
build/weavec2.wir
    │
    ▼ weavec1            (WIR → LLVM IR)
build/weavec2.ll
    │
    ▼ llvm-link          (link weavefront C runtime)
build/weavec2.bc
    │
    ▼ clang
build/weavec2
...
src/
  ...
  frontend/     — surface Weave → WIR frontend  (in progress)
